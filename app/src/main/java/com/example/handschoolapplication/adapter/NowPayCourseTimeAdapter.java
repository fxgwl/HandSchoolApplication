...
public class NowPayCourseTimeAdapter extends BaseAdapter {

    private List<CourseTimeBean.DataBean> mList;
    private Context context;

    public NowPayCourseTimeAdapter(List<CourseTimeBean.DataBean> mList, Context context) {
        this.mList = mList;
