...
public class ClassTypeFirstAdapter extends BaseAdapter {
    private Context context;
    private List<ClassType> mlist;
    private int size = 0;
    private OnDelectTypeListener listener;
    public ClassTypeFirstAdapter(Context context, List<ClassType> mlist) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = View.inflate(context, R.layout.classtype_first_item, null);
