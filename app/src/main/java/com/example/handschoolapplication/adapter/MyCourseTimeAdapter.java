...
public class MyCourseTimeAdapter extends BaseAdapter {

    private List<LearningCourseBean.CourseTimeInfoBean> mList;
    private Context context;

    public MyCourseTimeAdapter(List<LearningCourseBean.CourseTimeInfoBean> mList, Context context) {
        this.mList = mList;
