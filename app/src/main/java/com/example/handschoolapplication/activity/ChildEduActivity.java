...
public class ChildEduActivity extends BaseActivity implements CommonPopupWindow.ViewInterface, View.OnClickListener, AdapterView.OnItemClickListener {
...
//        startLocate();
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        Log.e("aaa",
                                "(ChildEduActivity.java:140)" + e.getMessage());
                    }

                    @Override
                    public void onResponse(String response, int id) {
                        Log.e("aaa",
                                "(ChildEduActivity.java:146)" + response);
    ...
    BaiduMap.OnMapClickListener listener = new BaiduMap.OnMapClickListener() {
        ...
        public void onMapClick(LatLng point) {
            startActivity(new Intent(ChildEduActivity.this, BaiduMapActivity.class));
            baiduMap.clear();
        }
    ...
    private void getSecondList(final String typeOne) {
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        Log.e("aaa",
                                "(ChildEduActivity.java:203)" + e.getMessage());
                    }
...
//                break;
    ...
    class MyCourseAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(ChildEduActivity.this).load(Internet.BASE_URL + courseSortBean.getCourse_photo()).centerCrop().into(holder.ivCourse);
    ...
    class MyClassAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            Glide.with(ChildEduActivity.this)
