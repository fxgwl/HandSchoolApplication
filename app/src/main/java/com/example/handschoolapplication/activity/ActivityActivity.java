...
public class ActivityActivity extends BaseActivity implements CommonPopupWindow.ViewInterface, View.OnClickListener {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_search://搜索
                startActivity(new Intent(ActivityActivity.this, SearchActivity.class));
                break;
            case R.id.tv_sort:
            ...
            case R.layout.popupwindow_sort:
                ...
                hlvSort.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Toast.makeText(ActivityActivity.this, types.get(position).toString(), Toast.LENGTH_SHORT).show();
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(ActivityActivity.this, R.layout.item_find_course_lv, null);
