...
public class CommentManagerActivity extends AppCompatActivity implements CommentManagerAdapter.ReplyEvaluateListener {
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        Log.e("aaa",
                                "(CommentManagerActivity.java:69)" + InternetS.CLASS_EVALUATE_MANAGER);
                        Log.e("aaa",
                        ...
                        try {
                            ...
                            Gson gson = new Gson();
                            mList.addAll((Collection<? extends EvaluateManagerBean>) gson.fromJson(data.toString(),new TypeToken<ArrayList<EvaluateManagerBean>>(){}.getType()));
